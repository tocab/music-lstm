...
from extract_notes import notes_to_midi
...
input_pitch[0, :50] = sample["input_pitch"].to(DEVICE)
input_step[0, :50] = sample["input_step"].to(DEVICE)
input_duration[0, :50] = sample["input_duration"].to(DEVICE)
